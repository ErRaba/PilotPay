...
## v7 — Modelo de conceptos de préstamo, prorrata y especie

- La paga extra prorrateada se trata como devengo mensual: suma a total devengado, Base IRPF y Base SS.
- En modo 14 pagas, la extra completa se devenga solo en julio/diciembre; la Base SS mantiene la prorrata mensual.
- El préstamo queda dividido en dos campos:
  - amortización: deducción neta que reduce líquido, sin afectar bases;
  - intereses: devengo sujeto a SS e IRPF, introducido manualmente.
- Seguro de vida en especie parametrizado por función: CMD 43,33 € y COP 9,92 € según nóminas reales disponibles.
